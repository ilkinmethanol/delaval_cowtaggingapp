...
public class FirmwareVersionSetting extends NumberTagSetting implements TagSetting {

    public FirmwareVersionSetting(int offset, SettingType type, String name, boolean display){
